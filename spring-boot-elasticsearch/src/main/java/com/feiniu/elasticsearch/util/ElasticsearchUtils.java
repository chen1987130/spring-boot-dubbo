package com.feiniu.elasticsearch.util;
...
public class ElasticsearchUtils {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> searchListData(String index, String type, Integer size, String matchStr) {
		return searchListData(index, type, size, null, null, false, null, matchStr);
	}
	...
	public List<Map<String, Object>> searchListData(String index, String type, Integer size, String fields,
			String matchStr) {
		return searchListData(index, type, size, fields, null, false, null, matchStr);
	}
	...
	public List<Map<String, Object>> searchListData(String index, String type, Integer size, String fields,
		...
		return searchListData(index, type, size, fields, sortField, matchPhrase, null, matchStr);
	}
	...
	public List<Map<String, Object>> searchListData(String index, String type, Integer size, String fields,
		...
		EsPage page = searchDataPage(index, type, 1, size, fields, sortField, matchPhrase, highlightField, matchStr);
		if (page != null) {
	 ...
	 * @return
	 */
	public EsPage searchDataPage(String index, String type, int currentPage, int pageSize, String fields,
			String sortField, boolean matchPhrase, String highlightField, String matchStr) {
		...
		for (SearchHit searchHit : searchResponse.getHits().getHits()) {
			...
			if (StringUtils.isNotEmpty(highlightField)) {
				...
				if (text != null) {
					...
					// 遍历高亮结果集，覆盖正常结果集
					searchHit.getSource().put(highlightField + "Highlight", stringBuffer.toString());
				}
			}
